...
class FitnessStoryComponent extends StatefulWidget {
  static String tag = '/FitnessStoryComponent';
  final DefaultPostResponse mPost;
  final Function? onCall;

  FitnessStoryComponent(this.mPost, {this.onCall});

  @override
  FitnessStoryComponentState createState() => FitnessStoryComponentState();
}

class FitnessStoryComponentState extends State<FitnessStoryComponent> {
  @override
  void initState() {
    super.initState();
    init();
